...
import team.bham.repository.QuestionRepository;
...
class QuestionResourceIT {
    ...
    private static final QuesType DEFAULT_QUES_TYPE = QuesType.MULTI_CHOICE;
    private static final QuesType UPDATED_QUES_TYPE = QuesType.FILL_IN;
    ...
    public static Question createEntity(EntityManager em) {
        Question question = new Question().question(DEFAULT_QUESTION).quesType(DEFAULT_QUES_TYPE);
        return question;
    }
    ...
    public static Question createUpdatedEntity(EntityManager em) {
        Question question = new Question().question(UPDATED_QUESTION).quesType(UPDATED_QUES_TYPE);
        return question;
    }
    ...
    void createQuestion() throws Exception {
        ...
        assertThat(testQuestion.getQuesType()).isEqualTo(DEFAULT_QUES_TYPE);
    }
    ...
    @Test
    @Transactional
    void checkQuesTypeIsRequired() throws Exception {
        int databaseSizeBeforeTest = questionRepository.findAll().size();
        // set the field null
        question.setQuesType(null);
    ...
    void getAllQuestions() throws Exception {
        ...
        restQuestionMockMvc
            ...
            .andExpect(jsonPath("$.[*].quesType").value(hasItem(DEFAULT_QUES_TYPE.toString())));
    }
    ...
    void getQuestion() throws Exception {
        ...
        restQuestionMockMvc
            ...
            .andExpect(jsonPath("$.quesType").value(DEFAULT_QUES_TYPE.toString()));
    }
    ...
    void putExistingQuestion() throws Exception {
        ...
        updatedQuestion.question(UPDATED_QUESTION).quesType(UPDATED_QUES_TYPE);
        ...
        assertThat(testQuestion.getQuesType()).isEqualTo(UPDATED_QUES_TYPE);
    }
    ...
    void partialUpdateQuestionWithPatch() throws Exception {
        ...
        partialUpdatedQuestion.question(UPDATED_QUESTION).quesType(UPDATED_QUES_TYPE);
