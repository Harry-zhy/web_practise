...
class EventResourceIT {
    ...
    private static final Integer DEFAULT_SPACES = 1;
    private static final Integer UPDATED_SPACES = 2;
    ...
    public static Event createEntity(EntityManager em) {
        Event event = new Event().date(DEFAULT_DATE).spaces(DEFAULT_SPACES).title(DEFAULT_TITLE);
        return event;
    }
    ...
    public static Event createUpdatedEntity(EntityManager em) {
        Event event = new Event().date(UPDATED_DATE).spaces(UPDATED_SPACES).title(UPDATED_TITLE);
        return event;
    }
    ...
    void createEvent() throws Exception {
        ...
        assertThat(testEvent.getSpaces()).isEqualTo(DEFAULT_SPACES);
    ...
    void getAllEvents() throws Exception {
        ...
        restEventMockMvc
            ...
            .andExpect(jsonPath("$.[*].spaces").value(hasItem(DEFAULT_SPACES)))
    ...
    void getEvent() throws Exception {
        ...
        restEventMockMvc
            ...
            .andExpect(jsonPath("$.spaces").value(DEFAULT_SPACES))
    ...
    void putExistingEvent() throws Exception {
        ...
        updatedEvent.date(UPDATED_DATE).spaces(UPDATED_SPACES).title(UPDATED_TITLE);
        ...
        assertThat(testEvent.getSpaces()).isEqualTo(UPDATED_SPACES);
    ...
    void partialUpdateEventWithPatch() throws Exception {
        ...
        partialUpdatedEvent.spaces(UPDATED_SPACES);
    ...
    void fullUpdateEventWithPatch() throws Exception {
        ...
        partialUpdatedEvent.date(UPDATED_DATE).spaces(UPDATED_SPACES).title(UPDATED_TITLE);
