...
import team.bham.repository.NotificationRepository;
import team.bham.web.rest.errors.BadRequestAlertException;
import tech.jhipster.web.util.HeaderUtil;
import tech.jhipster.web.util.ResponseUtil;

/**
 * REST controller for managing {@link team.bham.domain.Notification}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class NotificationResource {
    ...
    public List<Notification> getAllNotifications(@RequestParam(required = false) String filter) {
        if ("message-is-null".equals(filter)) {
            log.debug("REST request to get all Notifications where message is null");
