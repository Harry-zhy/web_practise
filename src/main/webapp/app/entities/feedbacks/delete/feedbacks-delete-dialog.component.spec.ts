...
import { FeedbacksDeleteDialogComponent } from './feedbacks-delete-dialog.component';

describe('Feedbacks Management Delete Component', () => {
  let comp: FeedbacksDeleteDialogComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      .overrideTemplate(FeedbacksDeleteDialogComponent, '')
      .compileComponents();
