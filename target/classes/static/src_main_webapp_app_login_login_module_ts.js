"use strict";
(self["webpackChunkteamproject"] = self["webpackChunkteamproject"] || []).push([["src_main_webapp_app_login_login_module_ts"],{
...
/* harmony import */ var app_login_login_service__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! app/login/login.service */ 77115);
...
class LoginComponent {
    constructor(accountService, loginService, router) {
        ...
        this.loginForm = new _angular_forms__WEBPACK_IMPORTED_MODULE_3__.FormGroup({
            username: new _angular_forms__WEBPACK_IMPORTED_MODULE_3__.FormControl('', { nonNullable: true, validators: [_angular_forms__WEBPACK_IMPORTED_MODULE_3__.Validators.required] }),
            password: new _angular_forms__WEBPACK_IMPORTED_MODULE_3__.FormControl('', { nonNullable: true, validators: [_angular_forms__WEBPACK_IMPORTED_MODULE_3__.Validators.required] }),
            rememberMe: new _angular_forms__WEBPACK_IMPORTED_MODULE_3__.FormControl(false, { nonNullable: true, validators: [_angular_forms__WEBPACK_IMPORTED_MODULE_3__.Validators.required] }),
        });
    }
    ngOnInit() {
